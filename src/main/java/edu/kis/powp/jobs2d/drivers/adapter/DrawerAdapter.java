...
import edu.kis.powp.jobs2d.features.DrawerFeature; // remove this
...
public class DrawerAdapter extends DrawPanelController implements Job2dDriver {
	...
	public DrawerAdapter() { // dodaj tutaj DrawPanelController
		super();
	...
	public void operateTo(int x, int y) {
		...
		this.drawPanelController.drawLine(line); // fix this
	}
