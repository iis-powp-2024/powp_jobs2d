...
import edu.kis.powp.jobs2d.events.FigureCase;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		application.addTest("Square", selectTestFigureOptionListener4);
	}
