...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		application.addTest("Complex command - Rectangle", selectTestFigureOptionListener3);
		application.addTest("Complex command - Triangle", selectTestFigureOptionListener4);
	}
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver basicLineDriver = new DrawPanelAdapter();
